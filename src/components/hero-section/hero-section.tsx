            ...
            <div className={s.container}>
                <div className={s.body}>
                    <div className={s.article}>
                        ...
                        <div className={s.text}>Удобный сервис, который подберёт для вас коллег и поможет наладить с ними
                            взаимовыгодное сотрудничество в областях совместных исследований, соавторства,
                            рецензирования и повышения индекса цитирования.</div>
                        <button type="button" className={s.btn}>Присоединиться</button>
                    </div>
